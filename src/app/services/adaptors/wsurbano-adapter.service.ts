        ...
        return this.apiService.get(this.endpoint, httpParams).pipe(
            map((response: any) => {
                ...
                response.Matricula.forEach((resource: any) => {
                    let itemReturn: AdaptorReturnStruct =
                        new AdaptorReturnStruct();
    ...
    getFilteredData(
        ...
        return this.apiService.get(this.endpoint, httpParams).pipe(
            map((response: any) => {
                ...
                response.Localidade.forEach((resource: any) => {
                    let itemReturn: PedagioComboStruct =
                        new PedagioComboStruct();
