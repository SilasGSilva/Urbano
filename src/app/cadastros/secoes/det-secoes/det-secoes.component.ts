...
import { poLookUpOrigem, poLookUpDestino, poLookUpAssociarLinhas } from 'src/app/services/adaptors/wsurbano-adapter.service';
...
export class DetSecoesComponent {
	...
	createForm(): any {
		...
		this.secaoForm = this._formBuilder.group({
			...
			associarLinhas: [secao.associarLinhas, Validators.compose([Validators.required])],
