...
import { PoDynamicViewField, PoNotificationService, PoPageAction, PoBreadcrumb } from '@po-ui/ng-components';
...
export class ViewPedagiosComponent {
	...
	public columnsDynamicView: Array<PoDynamicViewField> = this._structPedagio.ColumnsDynamicView;
	...
	actions: Array<PoPageAction> = [
		{
			label: 'Editar',
			action: () => {
				this._router.navigate(['pedagios/detPedagios', 'editar', btoa(this.filial), this.pk]);
			},
		},
		{
			label: 'Fechar',
