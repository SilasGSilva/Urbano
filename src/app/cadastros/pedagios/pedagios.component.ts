...
export class PedagiosComponent {
  ...
  setFilters() {
    ...
    //filtros
    if (
      this.pedagioFilterCombo !== undefined &&
      this.pedagioFilterCombo.selectedOption !== undefined
    ) {
      if (this.filters != '') {
        this.filters += ' AND ';
      }
      this.filters +=
        " GI1_COD = '" + this.pedagioFilterCombo.selectedOption.value + "' ";
    }
    if (
      this.valorFilterCombo !== undefined &&
      this.valorFilterCombo.selectedOption !== undefined
    ) {
      this.valorFilter =
    ...
    if (
      ...
      this.vigenciafilterRange.dateRange.start !== undefined
    ) {
      this.vigenciafilterRange.dateRange.start =
        " AND ( UPPER(GI1_COD) LIKE UPPER('" +
        this.vigenciafilterRange.dateRange.start +
    ...
    if (
      ...
      this.vigenciafilterRange.dateRange.end !== undefined
    ) {
      this.vigenciafilterRange.dateRange.end =
        " AND ( UPPER(GI1_COD) LIKE UPPER('" +
        this.vigenciafilterRange.dateRange.end +
