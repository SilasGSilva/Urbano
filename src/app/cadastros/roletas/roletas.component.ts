...
import { PoTableColumn, PoPageAction, PoBreadcrumb, PoTableColumnSort } from '@po-ui/ng-components';
...
export class RoletasComponent {
	...
	editValiddador(event: any) {
		this._router.navigate(['roletas/detRoletas', 'editar', btoa(event.pk), event.pk]);
	}
}
